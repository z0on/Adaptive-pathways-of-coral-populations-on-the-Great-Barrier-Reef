...
* **slimQTL_v4.txt** : latest version of the model: runs much faster and scales well to 100s of populations. Example input files for this model are 10reefs.txt and 10reefs_environment.txt. **Requires SLiM 2.4 [GiHub](https://github.com/MesserLab/SLiM)**
