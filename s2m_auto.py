...
poptg = dadi.Inference.optimize_log(params, data, S2MM, pts,
...
print 's2m ',sys.argv[1],sys.argv[2],sys.argv[3],' logLike :', ll_model
theta = dadi.Inference.optimal_sfs_scaling(model, data)
print 's2m ',sys.argv[1],sys.argv[2],sys.argv[3],' theta:', theta

dadi.Plotting.plot_2d_comp_multinom(model, data, vmin=1, resid_range=3,
                                    pop_ids = pop_ids)
plt.savefig('s2m_'+sys.argv[1]+sys.argv[2]+sys.argv[3]+'.pdf')
